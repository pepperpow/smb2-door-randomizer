...
There is a slot for eye whites, the eye whites should use the FIRST non transparent color in your palette, but will appear white when used.

EYES MIGHT REQUIRE SOME TWEAKING, they always appear on the top left corner of your character.

There are 3 commands for setting particular features of a character, pwalk, flutter, wide.
