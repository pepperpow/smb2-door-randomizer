...
my_title = {'type':'text', 'val':'↑ ↑ ↑  Select one of the above to get started ↑ ↑ ↑ \n\n'\
                                    'To generate a Rom, click one of the tabs "Basic" or "Openworld",\nthen press a Quick Start button!\n'}
...
frame_level_randomizer_basic = {'type':'frame', 'title':'Level Randomizer (Basic)', 'val':[
    ...
    [{'type':'img', 'val':"ui/icons/testicon1.png"},
        {'type':'button', 'val':'3 levels', 'key':"basicMini", 'font':('System', 12), 'metadata':{'k':3}},
        {'type':'button', 'val':'9 levels', 'key':"basicShort", 'font':('System', 12), 'metadata':{'k':9}},
        {'type':'button', 'val':'15 levels', 'key':"basicMedium", 'font':('System', 12), 'metadata':{'k':15}},
        {'type':'button', 'val':'20 levels', 'key':"basicLong", 'font':('System', 12), 'metadata':{'k':20}}], # 2
    [{'type':'text', 'val':'Randomly string rooms together into new levels', 'font':('', 8)}], # 3
    [{'type':'text', 'val':'  (Still being tested as of 0.49!)'}], # 4
    [{'type':'img', 'val':"ui/icons/testicon1a.png"},
        {'type':'button', 'val':'3 levels', 'key':"stringMini", 'font':('System', 12), 'metadata':{'k':3}},
        {'type':'button', 'val':'9 levels', 'key':"stringShort", 'font':('System', 12), 'metadata':{'k':9}},
        {'type':'button', 'val':'15 levels', 'key':"stringMedium", 'font':('System', 12), 'metadata':{'k':15}},
        {'type':'button', 'val':'20 levels', 'key':"stringLong", 'font':('System', 12), 'metadata':{'k':20}}, ] # 5
    ]} # end of frame 
...
frame_level_randomizer_map = {'type':'frame', 'title':'Door Randomizer Beta', 'val':[
    ...
    [{'type':'text', 'val':'(Still being tested as of 0.49!)'}],
    [{'type':'img', 'val':"ui/icons/testicon2.png"},
        {'type':'button', 'val':'1 Boss', 'key':"bossWart", 'font':('System', 12), 'metadata':{'k': 12, 'boss': 1}},
        {'type':'button', 'val':'3 Bosses', 'key':"bossShort", 'font':('System', 12), 'metadata':{'k': 12, 'boss': 3}},
        {'type':'button', 'val':'5 Bosses', 'key':"bossMedium", 'font':('System', 12), 'metadata':{'k': 15, 'boss': 5}},
        {'type':'button', 'val':'7 Bosses', 'key':"bossLong", 'font':('System', 12), 'metadata':{'k': 20, 'boss': 7}}],
    ...
    [{'type':'select', 'title': 'Map Scale', 'val': ['Default', 3, 9, 12, 15, 20], 'key':'presetMapScale'} ],
    ], 'key':'betaMap'} 

bonus_settings_1 = {'type':'column', 'just':'center', 'val':[[
        {'type':'checkbox', 'val':'Extra Lives', 'key':'presetBonusLives'}, 
        {'type':'checkbox', 'val':'Bonus Health', 'key':'presetBonusHealth', 'tooltip': 'Gives an extra hit on spawn'},
        {'type':'checkbox', 'val':'Secret Detection', 'key':'presetSecret', 'tooltip': 'Highlights mushroom locations'}, ]]
        }
        # 'just':'right', 'pad':(10,0)} # justifcation, pad

bonus_settings_2 = {'type':'column', 'just':'center', 'val':[[
        {'type':'checkbox', 'val':'Inverted Levels', 'key':'presetInvert', 'default':True, 'tooltip': 'Flip a level horizontally'},
...
bonus_settings_3 = {'type':'column', 'just':'center', 'val':[[]]}
        # {'type':'checkbox', 'val':'Shuffle Bushes', 'key':'presetBushes', 'default':False, 'tooltip': 'Shuffle contents in room bushes'},
        # {'type':'checkbox', 'val':'Shuffle Mushrooms', 'key':'presetMushrooms', 'default':False, 'tooltip': 'Move mushrooms around current room'},]]
        # }

char_rules = {'type':'select', 'title': 'Character Rules', 'val': ['Select Character After Death', 'Survival Mode, lives per character', 'Force Character per Room', 'Select Anytime (select+LR}'], 'key':'presetCharRule'}
...
layout_titls = [
    'Begin', 'Basic', 'Openworld', 'More Settings'
]
